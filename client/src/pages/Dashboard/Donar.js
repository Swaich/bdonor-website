...
import { FaUser, FaSearch, FaUsers, FaHospital, FaTachometerAlt, FaChartLine } from "react-icons/fa";
...
const Donar = () => {
  ...
  const filteredDonors = data?.filter(donor => 
    ...
    donor.organisationName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <Layout>
      <div className="container mx-auto px-4 py-6">
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600 text-lg">B-Donor Donor Dashboard</p>
        </div>
                        ...
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10 bg-blue-100 rounded-full flex items-center justify-center">
                            <span className="text-blue-600 font-bold">
                              {(record.name?.charAt(0) || record.organisationName?.charAt(0) || "?").toUpperCase()}
                            </span>
                          </div>
                          <div className="ml-4">
